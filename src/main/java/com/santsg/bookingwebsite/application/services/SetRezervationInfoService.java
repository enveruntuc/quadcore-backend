...
@Service
public class SetRezervationInfoService {

     private final RestClient restClient;

     public SetRezervationInfoService() {
         this.restClient = RestClient.create();
     }
      

     public ApiResponse<SetReservationInfoResponseBody> setReservationInfo(String token, SetReservationInfoRequest setReservationInfoRequest) {
         ...
         try {
             ...
             ApiResponse<SetReservationInfoResponseBody> apiResponse = objectMapper.readValue(
                     response,
                     objectMapper.getTypeFactory().constructParametricType(ApiResponse.class, SetReservationInfoResponseBody.class)
             );
             return apiResponse;
